...
public interface IUsuarioRepository {
    ...
    Usuario registrarUsuario(UsuarioDTO usuarioDTO) throws BadRequestException, ResourceNotFoundException, ExistException, MessagingException, UnsupportedEncodingException, ServiceUnavailable;
